...
public class AppUtil {
    ...
    public static Iterable<FevMember> parseMember(MemberModel data) {
        ...
        final String[] HEADERS = {"id", "fullname", "studentID", "{name: birthdate, format: yyyy-MM-dd}", "sex",
                "address", "phone", "{name: position, subName: position}", "{name: status, subName: status}", "point",
                "note"};
